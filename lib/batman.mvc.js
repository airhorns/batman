(function() {
        ...
        var route = function() {
            ...
            if (result && result.isView) {
                result.onready(function() {
                    Batman.View.content('main', result);
                });
    ...
    Batman.View = Batman.Mixin({
        ...
        template: function(template) {
            Batman.request(Batman.request.base + 'views/' + template + '.html', function(html) {
                this._template = html;
    ...
    Batman.View.content = function(yield, view) {
        if (!Batman.View._yieldContents)
            Batman.View._yieldContents = {};
        
        Batman.View._yieldContents[yield] = view;
        
        if (!Batman.View._yields)
            return;
        
        var container = Batman.View._yields[yield];
