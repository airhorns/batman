...
(function() {
    ...
    Batman.Model = Batman.Mixin({
        ...
        create: function(identifier) {
            var mixin = Batman.Mixin(typeof identifier === 'string' ? identifier : null, Batman.Record);
            mixin.prototype.model = mixin;
            
            mixin.enhance(Array.toArray(arguments));
            mixin.mixin(Batman.Model);
    ...
    Batman.Record = Batman.Mixin(Batman.Transactionable, {
        ...
        readFromStore: function(callback) { callback(); },
        writeToStore: function(callback) { callback(); },
        removeFromStore: function(callback) { callback(); }
    });
