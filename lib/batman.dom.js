(function() {
        ...
        node: function(node, contexts) {
            ...
            if (typeof node.getAttribute === 'function') {
                ...
                for (var i = -1, count = attributes.length; ++i < count;) {
                    ...
                    else if (binding.substr(0,8) === 'formfor-')
                        result = Batman.DOM.bindForm(binding.substr(8), attributeValue, node, contexts);
        ...
        bindings: {
            ...
            classes: function(string, node, contexts) {
                ...
                for (var key in classes) {
                    ...
                    binding.observe(observer(key), true);
                }
            },
    ...
    Batman.Animation = Batman.Mixin.Abstract('animation', {
        show: function() {
    ...
    Batman.Editor = Batman.Mixin.Abstract('editor', {
        onclick: function(e) {
