(function() {
  var $block, $event, $eventOneShot, $findName, $mixin, $redirect, $route, $typeOf, $unmixin, Batman, Binding, RenderContext, Validators, buntUndefined, camelize_rx, capitalize_rx, container, escapeRegExp, filters, helpers, k, mixins, namedOrSplat, namedParam, queryParam, splatParam, underscore_rx1, underscore_rx2, unmixinableKeys, _Batman, _class, _fn, _i, _len, _objectToString, _ref, _stateMachine_setState;
  ...
  Batman.ObservableProperty = (function() {
    ...
    ObservableProperty.prototype.fireDependents = function() {
      if (this.dependents) {
        return this.dependents.each(function(prop) {
          if (typeof prop.hasObservers === "function" ? prop.hasObservers() : void 0) {
    ...
    ObservableProperty.prototype.hasObservers = function() {
      ...
      if (this.base._batman != null) {
        return this.base._batman.ancestors().some(__bind(function(ancestor) {
          var _ref, _ref2;
          return ((_ref = ancestor.property(this.key)) != null ? (_ref2 = _ref.observers) != null ? _ref2.length : void 0 : void 0) > 0;
        }, this));
      } else {
        return false;
      }
  ...
  */
  ...
  Batman.SimpleHash = (function() {
    ...
    SimpleHash.prototype.clear = function() {
      return this.each(__bind(function(obj) {
  ...
  Batman.Set = (function() {
    ...
    _ref3 = ['has', 'each', 'isEmpty', 'toArray', 'clear', 'merge'];
  ...
  Binding = (function() {
    ...
    function Binding() {
      var shouldSet, unfilteredValue, _ref2;
      Binding.__super__.constructor.apply(this, arguments);
      this.parseFilter();
      if (this.key) {
        _ref2 = this.renderContext.findKey(this.key), unfilteredValue = _ref2[0], this.keyContext = _ref2[1];
      }
      shouldSet = true;
  ...
  Batman.DOM = {
    readers: {
      ...
      context: function(node, key, context) {
        var subContext, value, _ref2;
        _ref2 = context.findKey(key), value = _ref2[0], subContext = _ref2[1];
      ...
      foreach: function(node, iteratorName, key, context, parentRenderer) {
        ...
        if (collection != null ? collection.observe : void 0) {
          ...
          collection.observe('remove', remove = function(item) {
            ...
            return oldNode != null ? (_ref2 = oldNode.parentNode) != null ? _ref2.removeChild(oldNode) : void 0 : void 0;
          });
    ...
    events: {
      ...
      change: function(node, callback) {
        var eventName, eventNames, _j, _len2, _results;
        eventNames = (function() {
