(function() {
  var $block, $event, $eventOneShot, $findName, $mixin, $redirect, $route, $typeOf, $unmixin, Batman, camelize_rx, escapeRegExp, filters, global, helpers, matchContext, mixins, namedOrSplat, namedParam, splatParam, underscore_rx1, underscore_rx2, _objectToString;
  ...
  Batman.Observable = {
    ...
    unsetWithoutKeypaths: function(key) {
      ...
      Batman.Observable.rememberingOutboundTriggerValues.call(this, key, function() {
        ...
        } else if (typeof this._unset === 'function') {
          this._unset(key);
        } else {
          this[key] = null;
          delete this[key];
  ...
  Batman.Hash = (function() {
    ...
    Hash.prototype._unset = function(key) {
  ...
  Batman.exportGlobals = function() {
    return Batman.exportHelpers(global);
  };
