(function() {
  var $block, $event, $eventOneShot, $findName, $get, $mixin, $redirect, $typeOf, $unmixin, Batman, BatmanObject, Binding, RenderContext, Validators, buildParams, buntUndefined, camelize_rx, capitalize_rx, container, filters, helpers, k, mixins, param, prefixes, r20, rbracket, underscore_rx1, underscore_rx2, _Batman, _fn, _i, _inGlobalScope, _j, _len, _len2, _objectToString, _ref, _ref2, _stateMachine_setState;
