(function() {
  var $addEventListener, $block, $extendsEnumerable, $findName, $functionName, $get, $hasAddEventListener, $isChildOf, $mixin, $passError, $preventDefault, $redirect, $removeEventListener, $removeNode, $setInnerHTML, $typeOf, $unbindNode, $unbindTree, $unmixin, Batman, BatmanObject, Binding, Validators, buildParams, buntUndefined, camelize_rx, capitalize_rx, container, developer, div, filters, helpers, isEmptyDataObject, k, mixins, param, prefixes, r20, rbracket, t, underscore_rx1, underscore_rx2, _Batman, _fn, _i, _j, _len, _len2, _objectToString, _ref, _ref2, _stateMachine_setState;
  ...
  Batman.Property = (function() {
    ...
    Property.prototype.accessor = function() {
      var accessor, keyAccessors, val, _ref2, _ref3;
      keyAccessors = (_ref2 = this.base._batman) != null ? _ref2.get('keyAccessors') : void 0;
      accessor = keyAccessors && (val = keyAccessors.get(this.key)) ? val : ((_ref3 = this.base._batman) != null ? _ref3.getFirst('defaultAccessor') : void 0) || Batman.Property.defaultAccessor;
    ...
    Property.prototype.valueFromAccessor = function() {
      var _ref2;
      return (_ref2 = this.accessor().get) != null ? _ref2.call(this.base, this.key) : void 0;
    };
    Property.prototype.setValue = function(val) {
      var result, _ref2;
      result = (_ref2 = this.accessor().set) != null ? _ref2.call(this.base, this.key, val) : void 0;
      this.refresh();
      return result;
    };
    Property.prototype.unsetValue = function() {
      var result, _ref2;
      result = (_ref2 = this.accessor().unset) != null ? _ref2.call(this.base, this.key) : void 0;
      this.refresh();
      return result;
    };
    ...
    Property.prototype.fire = function() {
      var _ref2;
      return (_ref2 = this.changeEvent()).fire.apply(_ref2, arguments);
    };
  ...
  Batman.SimpleHash = (function() {
    ...
    SimpleHash.prototype.unset = function(key) {
      var index, obj, pair, pairs, value, _len2, _ref2;
      if (pairs = this._storage[this.hashKeyFor(key)]) {
  ...
  Batman.Renderer = (function() {
    ...
    function Renderer(node, callback, contexts) {
      ...
      this.context = contexts instanceof Batman.RenderContext ? contexts : (_ref2 = Batman.RenderContext).start.apply(_ref2, contexts);
  ...
  Batman.DOM.Iterator = (function() {
      ...
      if (this.collection) {
        if (this.collection.isObservable && this.collection.toArray) {
          ...
          this.collection.on('itemsWereAdded', this.currentAddedHandler = __bind(function() {
            var i, item, items, _len2, _results;
            items = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
            _results = [];
            for (i = 0, _len2 = items.length; i < _len2; i++) {
              item = items[i];
    ...
    Iterator.prototype.arrayChanged = function() {
      var existingNode, item, newItemsInOrder, trackingNodeMap, _j, _len2;
