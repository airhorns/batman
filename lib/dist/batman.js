(function() {
  ...
  Batman.HasManyAssociation = (function() {
    ...
    HasManyAssociation.prototype.setForRecord = function(record) {
      var id;
    ...
    HasManyAssociation.prototype.getAccessor = function(self, model, label) {
      var recordInAttributes, relatedRecords;
      if (this.amSetting) {
        return;
      }
      if (!self.getRelatedModel()) {
      ...
      if (relatedRecords = self.setForRecord(this)) {
        this.amSetting = true;
    ...
    HasManyAssociation.prototype.encoder = function() {
      ...
      return {
        ...
        decode: function(data, key, _, __, parentRecord) {
          ...
          relations = association.setForRecord(parentRecord) || new Batman.AssociationSet(void 0, association);
