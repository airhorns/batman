(function() {
  ...
  Batman.Property = (function() {
    ...
    Property.prototype.changeEvent = function() {
      ...
      return event = this.event('change');
    };
    Property.prototype.accessor = function() {
      ...
      return accessor = keyAccessors && (val = keyAccessors.get(this.key)) ? val : ((_ref3 = this.base._batman) != null ? _ref3.getFirst('defaultAccessor') : void 0) || Batman.Property.defaultAccessor;
    };
