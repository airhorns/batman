(function() {
  var $block, $event, $eventOneShot, $findName, $functionName, $get, $mixin, $passError, $redirect, $typeOf, $unmixin, Batman, BatmanObject, Binding, RenderContext, Validators, buildParams, buntUndefined, camelize_rx, capitalize_rx, container, div, filters, helpers, isEmptyDataObject, k, mixins, param, prefixes, r20, rbracket, underscore_rx1, underscore_rx2, _Batman, _fn, _i, _j, _len, _len2, _objectToString, _ref, _ref2, _stateMachine_setState;
  ...
  Batman.Model = (function() {
    ...
    Model.findOrCreate = function(attrs, callback) {
      ...
      if (record.isNew()) {
        ...
        foundRecord = this._mapIdentities([record])[0];
  ...
  Batman.RestStorage = (function() {
    ...
    RestStorage.prototype.readAll = function(_, recordsOptions, callback) {
      return this.optionsForCollection(recordsOptions, function(err, options) {
        var recordOptions, _ref2;
        _ref2 = this._filterData('before', 'readAll', err, recordOptions), err = _ref2[0], recordOptions = _ref2[1];
        if (err) {
          callback(err);
          return;
        }
        return new Batman.Request($mixin(options, {
          ...
          method: 'GET',
          success: __bind(function(data) {
            return callback.apply(null, this._filterData('after', 'readAll', void 0, data, recordOptions));
          }, this),
          error: __bind(function(error) {
            return callback.apply(null, this._filterData('after', 'readAll', error, error.request.get('response'), recordOptions));
          }, this)
        }));
      });
    };
