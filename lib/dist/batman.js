(function() {
  ...
  Batman.Model = (function() {
    ...
    Model.clear = function() {
      ...
      if ((_ref = this._batman.associations) != null) {
        _ref.reset();
      }
      return result;
    };
    ...
    Model.prototype.save = function(callback) {
      ...
      return this.validate(__bind(function(isValid, errors) {
        var associations, creating, _ref4, _ref5;
        if (!isValid) {
          if (typeof callback === "function") {
            callback(errors);
          }
        ...
        associations = (_ref4 = this.constructor._batman.associations) != null ? _ref4.getAllByType() : void 0;
        if (associations != null) {
          if ((_ref5 = associations.get('belongsTo')) != null) {
            _ref5.forEach(__bind(function(association, label) {
        ...
        return this._doStorageOperation((creating ? 'create' : 'update'), {}, __bind(function(err, record) {
          ...
          if (!err) {
            ...
            if (associations != null) {
              if ((_ref6 = associations.get('hasOne')) != null) {
            ...
            if (associations != null) {
              if ((_ref7 = associations.get('hasMany')) != null) {
  ...
  Batman.AssociationCurator = (function() {
    ...
    AssociationCurator.prototype.getAllByType = function() {
      ...
      _ref = this.constructor.availableAssociations;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        key = _ref[_i];
    ...
    AssociationCurator.prototype.associationForLabel = function(searchLabel) {
      var ret;
      ret = void 0;
    ...
    AssociationCurator.prototype.reset = function() {
      this.byLabelStorage.forEach(function(label, association) {
  ...
  Batman.DOM = {
    readers: {
      ...
      route: function(node, key, context) {
        var action, app, dispatcher, isHash, model, name, url, _, _ref2, _ref3, _ref4;
        if (key.substr(0, 1) === '/') {
          url = key;
        } else {
          isHash = key.indexOf('#') > 1;
          _ref2 = isHash ? key.split('#') : key.split('/'), key = _ref2[0], action = _ref2[1];
          _ref3 = context.findKey('dispatcher'), dispatcher = _ref3[0], app = _ref3[1];
          if (!isHash) {
            _ref4 = context.findKey(key), model = _ref4[0], _ = _ref4[1];
          }
    ...
    ViewBinding.prototype.dataChange = function(viewClassOrInstance) {
      ...
      this.view.on('ready', __bind(function() {
        ...
        if (typeof (_base = this.view).awakeFromHTML === "function") {
          _base.awakeFromHTML(node);
        }
        return this.renderer.allowAndFire('rendered');
      }, this));
      return this.die();
    };
    return ViewBinding;
