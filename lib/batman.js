  ...
  Batman.DOM = {
        ...
        if (node.nodeName.toLowerCase() === 'input' && node.getAttribute('type') === 'checkbox') {
          ...
          return renderer.rendered(function() {
            contextChange = function(newValue) {
              var child, match, matches, value, valueToChild, _base, _j, _k, _l, _len2, _len3, _len4, _len5, _m, _ref2, _ref3, _ref4, _results;
              ...
              for (_m = 0, _len5 = _ref4.length; _m < _len5; _m++) {
                child = _ref4[_m];
                _results.push(typeof (_base = Batman.data(child, 'selected')) === "function" ? _base() : void 0);
              }
              return _results;
            };
            nodeChange = function(node) {
              var boundValue, child, container, selections, _base, _j, _k, _len2, _len3, _ref2, _ref3, _ref4, _results;
              _ref2 = context.findKey(key), boundValue = _ref2[0], container = _ref2[1];
              selections = [];
              _ref3 = node.children;
    ...
    attrReaders: {
      ...
      bind: function(node, attr, key, context, only) {
        var boundValue, container, contextChange, nodeChange, _ref2;
        switch (attr) {
          case 'checked':
          case 'disabled':
          case 'selected':
            ...
            _ref2 = context.findKey(key), boundValue = _ref2[0], container = _ref2[1];
            Batman.data(node, attr, __bind(function() {
              return container.set(key, node.selected);
            }, this));
            break;
          case 'value':
            contextChange = function(value) {
