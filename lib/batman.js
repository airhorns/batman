(function() {
    ...
    Batman.msg = function(object, selector) {
        if (!object || !selector)
            return;
        ...
        if (typeof object[selector] === 'function')
            return object[selector].apply(object, args);
        else if (typeof object.methodMissing === 'function')
            return object.methodMissing(selector, args);
        else
            throw new TypeError(object + ' does not respond to selector: ' + selector);
    };
    
    Batman._msg = function(selector) {
        var args = Array.toArray(arguments);
        args.unshift(this);
        
        return Batman.msg.apply(Batman, args);
    };
    
    Batman.get = function(object, key) {
        var binding = object[key];
    ...
    Batman.set = function(object, key, value) {
        var binding = object[key];
    ...
    Batman.Mixin.prototype = {
        ...
        // Instance factory
        create: function() {
            return Batman(this.prototype, Array.toArray(arguments));
        },
