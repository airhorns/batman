(function() {
  var $addEventListener, $block, $event, $eventOneShot, $findName, $functionName, $get, $isChildOf, $mixin, $passError, $preventDefault, $redirect, $removeEventListener, $typeOf, $unmixin, Batman, BatmanObject, Binding, RenderContext, Validators, buntUndefined, camelize_rx, capitalize_rx, container, developer, div, filters, helpers, isEmptyDataObject, k, mixins, underscore_rx1, underscore_rx2, _Batman, _fn, _i, _ie_console, _j, _len, _len2, _objectToString, _ref, _ref2, _stateMachine_setState;
  ...
  developer = {
    ...
    log: function() {
      if (console.log.apply) {
        ...
        return _ie_console("log", arguments);
      }
    },
    warn: function() {
      if (console.warn.apply) {
        ...
        return _ie_console("warn", arguments);
      }
    },
  ...
  Batman.DOM = {
    readers: {
      source: function(node, key, context, renderer) {
        return Batman.DOM.readers.bind(node, key, context, renderer, 'source');
      },
  ...
  Batman.DOM.addEventListener = $addEventListener = (typeof window !== "undefined" && window !== null ? window.addEventListener : void 0) ? (function(node, eventName, callback) {
  ...
  Batman.DOM.removeEventListener = $removeEventListener = (typeof window !== "undefined" && window !== null ? window.removeEventListener : void 0) ? (function(elem, eventType, handler) {
