(function() {
  ...
  # batman.js
  # batman.coffee
  */  var $mixin, $redirect, $route, $typeOf, $unmixin, Batman, camelize_rx, escapeRegExp, global, helpers, namedOrSplat, namedParam, splatParam, underscore_rx1, underscore_rx2, _objectToString;
  ...
  */
  ...
  Batman._initializeObject = function(object) {
    if (!object.hasOwnProperty('_batman')) {
      return object._batman = {};
    }
  };
  Batman._initializeClass = function(object) {
    var _ref;
  ...
  */
  Batman.Observable = {
    initialize: function() {
      ...
      return (_base = this._batman).observers || (_base.observers = {});
    },
    get: function(key) {
      var value;
      value = this[key];
    ...
    set: function(key, value) {
      ...
      if (oldValue && oldValue.set) {
        ...
        this[key] = value;
        return this.fire(key, value, oldValue);
      }
    },
    unset: function(key) {
      var oldValue;
    ...
    fire: function(key, value, oldValue) {
      ...
      _ref2 = [this._batman.observers[key], (_ref = this.constructor.prototype._observers) != null ? _ref[key] : void 0];
  ...
  Batman.Preventable = {
    initialize: function() {
      Batman._initializeObject(this);
      return this._batman.preventCounts = {};
    },
