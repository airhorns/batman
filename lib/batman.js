(function() {
  ...
  Batman.Association.belongsTo = (function() {
    ...
    belongsTo.prototype.save = function(base) {
      ...
      if ((model = base.get(this.label)) && model.state() === "dirty") {
  ...
  Batman.Association.hasOne = (function() {
    ...
    hasOne.prototype.getAccessor = function(model, label, relatedModel) {
      var existingRelation, loadOptions, loadedRecord, modelName, relatedRecords;
      if (this.amSetting) {
        return;
      }
      existingRelation = Batman.Model.defaultAccessor.get.call(this, label);
      ...
      relatedRecords = relatedModel.get('loaded').indexedBy(modelName + '_id').get(this.id);
      if (!relatedRecords.isEmpty()) {
        return relatedRecords.toArray()[0];
      } else {
        loadOptions = {};
        loadOptions[modelName + '_id'] = this.id;
    ...
    hasOne.prototype.save = function(baseSaveError, base) {
      var foreignKey, model, saveEvent, _ref;
      saveEvent = base.event('modelSaved');
      if (model = (_ref = base._batman.attributes) != null ? _ref[this.label] : void 0) {
  ...
  Batman.Association.hasMany = (function() {
    ...
    hasMany.prototype.getAccessor = function(model, label, relatedModel) {
      var existingRelation, loadOptions, loadedRecords, modelName, relatedRecords;
      if (this.amSetting) {
        return;
      }
      existingRelation = Batman.Model.defaultAccessor.get.call(this, label);
