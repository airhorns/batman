(function() {
  ...
  */
  ...
  Batman.Hash = (function() {
    ...
    _ref = ['hasKey', 'equality', 'each', 'keys', 'merge', 'clear'];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      k = _ref[_i];
  ...
  Binding = (function() {
    ...
    function Binding() {
      ...
      this.observe('binding', true, __bind(function(value) {
        if (shouldSet) {
          if (this.dataChange) {
    ...
    events: {
      ...
      change: function(node, callback) {
        ...
        for (_i = 0, _len = eventNames.length; _i < _len; _i++) {
          ...
          _results.push(Batman.DOM.addEventListener(node, eventName, callback));
        }
        return _results;
      },
