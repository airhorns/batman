(function() {
  ...
  Batman.DOM.StyleBinding = (function() {
    ...
    StyleBinding.prototype.dataChange = function(value) {
      var colonSplitCSSValues, cssName, key, keyValue, keypathValue, style, _j, _len2, _ref2, _ref3, _results;
      var _this = this;
      if (!value) {
      ...
      if (existingActionNumber > options.actionNumber) {
        ...
        this.actions[options.actionNumber] = function() {
          ...
          if (addItem = node.getAttribute('data-additem')) {
            return (_ref2 = this.renderer.context.contextForKey(addItem)) != null ? typeof _ref2[addItem] === "function" ? _ref2[addItem](item, node) : void 0 : void 0;
          }
        };
