  ...
  Batman.Controller = (function() {
    ...
    Controller.prototype.render = function(options) {
      ...
      if (!options.view) {
        ...
        options.source || (options.source = helpers.underscore(controllerName) + '/' + this.get('action'));
        options.view = new (((_ref = Batman.currentApp) != null ? _ref[helpers.camelize("" + controllerName + "_" + (this.get('action')) + "_view")] : void 0) || Batman.View)(options);
      }
