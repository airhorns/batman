(function() {
    ...
    event: function(key) {
      ...
      if (events.hasKey(key)) {
        ...
        this._batman.ancestors(function(ancestor) {
          var _ref, _ref2;
          return existingEvent || (existingEvent = (_ref = ancestor._batman) != null ? (_ref2 = _ref.events) != null ? _ref2.get(key) : void 0 : void 0);
        });
  ...
  Batman.Property = (function() {
    ...
    Property.prototype.accessor = function() {
      ...
      var _this = this;
      if ((_bm = this.base._batman) != null) {
        accessor = (_ref = _bm.keyAccessors) != null ? _ref.get(this.key) : void 0;
        if (!accessor) {
          _bm.ancestors(function(ancestor) {
            var _ref2, _ref3;
            return accessor || (accessor = (_ref2 = ancestor._batman) != null ? (_ref3 = _ref2.keyAccessors) != null ? _ref3.get(_this.key) : void 0 : void 0);
          });
        }
        accessor || (accessor = _bm.getFirst('defaultAccessor'));
      }
      accessor || (accessor = Batman.Property.defaultAccessor);
      ...
      yieldFn = function(yieldingNode) {
        ...
        if (_yieldChildren) {
          while (node.childNodes.length > 0) {
            ...
            if (view != null) view.fire('appear', child);
          }
        } else {
