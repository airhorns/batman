(function() {
  ...
  Batman.RenderCache = (function() {
    ...
    RenderCache.prototype._evictExpiredKeys = function() {
      ...
      if (this.length > this.maximumLength) {
        for (i = _ref = this.maximumLength, _ref2 = this.keyQueue.length; _ref <= _ref2 ? i < _ref2 : i > _ref2; _ref <= _ref2 ? i++ : i--) {
          key = this.keyQueue[i];
  ...
  Batman.Controller = (function() {
    ...
    Controller.prototype.dispatch = function(action, params) {
      ...
      for (name in _ref3) {
        yield = _ref3[name];
        if (!~this._renderedYields.indexOf(name)) yield.clear();
      }
    ...
    Controller.prototype.render = function(options) {
      ...
      if ((_ref = this._renderedYields) != null) _ref.push(options.into);
      if (!options.view) {
  ...
  Batman.DOM = {
    ...
    willDestroyNode: function(node) {
      var child, view, _i, _len, _ref;
      view = Batman._data(node, 'view');
      if (view) view.fire('beforeDestroy', node);
      _ref = node.childNodes;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        child = _ref[_i];
    ...
    didDestroyNode: function(node) {
      ...
      view = Batman._data(node, 'view');
      if (view) view.fire('destroy', node);
      if (bindings = Batman._data(node, 'bindings')) {
