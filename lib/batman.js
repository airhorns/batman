  ...
  Batman.RestStorage = (function() {
    ...
    RestStorage.prototype.optionsForRecord = function(record, idRequired, callback) {
      ...
      if (record.url) {
        ...
        url = (typeof (_base = record.constructor).url === "function" ? _base.url() : void 0) || record.constructor.url || ("/" + (this.modelKey(record)));
    ...
    RestStorage.prototype.optionsForCollection = function(model, recordsOptions, callback) {
      var url;
      url = (typeof model.url === "function" ? model.url() : void 0) || model.url || ("/" + (this.modelKey(new model)));
      if (!url) {
