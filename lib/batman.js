(function() {
  ...
  Batman.App = (function() {
    ...
    App.run = function() {
      ...
      this.observe('layout', function(layout) {
        return layout != null ? layout.once('ready', function() {
  ...
  Batman.View = (function() {
    ...
    function View(options) {
      ...
      if ((this.get('source') != null) || (this.get('html') != null)) {
        this.set('waitForHTML', true);
      }
      Batman.Property.withoutTracking(function() {
        _this.set('constructed', true);
        return _this.observeAndFire('readyToRender', _this.render);
      });
    }

    View.store = new Batman.ViewStore();

    View.prototype.waitForHTML = false;
    ...
    View.accessor('node', {
      get: function() {
        if (!this.node) this.set('node', this._generateNode());
        return this.node;
      },
      set: function(_, node) {
        if (this.node != null) $removeNode(this.node);
        this.node = node;
    ...
    View.accessor('readyToRender', function() {
      return this.get('constructed') && (this.get('waitForHTML') ? this.get('html') != null : true) && (this.get('node') != null);
    });

    View.prototype.render = function() {
      var node;
      var _this = this;
      if (!this.get('readyToRender')) return;
      this.event('ready').resetOneShot();
      if (this.get('waitForHTML')) {
        $setInnerHTML(this.get('node'), this.get('html'));
      }
    ...
    View.prototype._generateNode = function() {
      var node;
      this.hasContainer = true;
      node = document.createElement('div');
      if (node.children.length > 0) Batman.data(node.children[0], 'view', this);
      return node;
    };
  ...
  Batman.DOM = {
    ...
    partial: function(container, path, context, renderer) {
      ...
      return view.once('ready', function() {
