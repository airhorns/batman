...
;
  /*
  Batman
  */  var $bind, $event, Batman, camelize_rx, global, helpers, toString, underscore_rx1, underscore_rx2;
  ...
  Batman.Model = (function() {
    ...
    Model.find = function(id) {
      return new this(App.dataStore.get(id));
    };
    function Model() {
      this._data = {};
  ...
  Batman.DOM = {
    attributes: {
      ...
      yield: function(key, node, context) {
        return Batman.DOM.yield(key, node);
      },
      contentFor: function(key, node, context) {
