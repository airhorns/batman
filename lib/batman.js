(function() {
  ...
  Batman.Controller = (function() {
    ...
    Controller.beforeFilter = function(options, nameOrFunction) {
      ...
      Batman.initializeObject(this);
      nameOrFunction.options = options;
    ...
    Controller.prototype.dispatch = function(action, params) {
      var filter, filters, oldRedirect, options, redirectTo, _i, _j, _len, _len2, _ref, _ref2, _ref3, _ref4, _ref5;
      if (params == null) {
        params = {};
      }
      ...
      if (filters = (_ref3 = this.constructor._batman) != null ? _ref3.get('beforeFilters') : void 0) {
        for (_i = 0, _len = filters.length; _i < _len; _i++) {
          filter = filters[_i];
          if (options = filter != null ? filter.options : void 0) {
