  ...
  Batman.Controller = (function() {
    ...
    Controller.prototype.redirect = function(url) {
      if (this._actedDuringAction && this._inAction) {
        developer.warn("Warning! Trying to redirect but an action has already be taken during " + (this.get('controllerName')) + "." + this._currentAction + "}");
      }
      if (this.get('action')) {
    ...
    Controller.prototype.render = function(options) {
      ...
      if (this._actedDuringAction && this._inAction) {
        developer.warn("Warning! Trying to render but an action has already be taken during " + (this.get('controllerName')) + "." + this._currentAction + "}");
      }
      this._actedDuringAction = true;
      if (options === false) {
        return;
