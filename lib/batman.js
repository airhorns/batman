(function() {
  ...
  Batman.LocalStorage = (function() {
    ...
    LocalStorage.prototype.read = function(record, options, callback) {
      return this.runBeforeFilter('read', {
        record: record,
        options: options
      }, function(_arg) {
        ...
        return this.runAfterFilter('read', {
    ...
    LocalStorage.prototype.create = function(record, options, callback) {
      return this.runBeforeFilter('create', {
        record: record,
        options: options
      }, function(_arg) {
        var error, key, recordAttributes;
        error = _arg.error, key = _arg.key, recordAttributes = _arg.recordAttributes;
        if (error == null) {
        ...
        return this.runAfterFilter('create', {
          record: record,
          error: error
        }, callback);
      });
    ...
    LocalStorage.prototype.update = function(record, options, callback) {
      return this.runBeforeFilter('update', {
        record: record,
        options: options
      }, function(_arg) {
        var error, key, recordAttributes;
        ...
        return this.runAfterFilter('update', {
          record: record,
          error: error
        }, callback);
      });
    ...
    LocalStorage.prototype.destroy = function(record, options, callback) {
      return this.runBeforeFilter('destroy', {
        record: record,
        options: options
      }, function(_arg) {
        var error, key, recordAttributes;
        ...
        return this.runAfterFilter('destroy', {
          record: record,
          error: error
        }, callback);
      });
    ...
    LocalStorage.prototype.readAll = function(proto, options, callback) {
      return this.runBeforeFilter('readAll', {
        ...
        var error, options, recordsAttributes, _ref;
        error = _arg.error, options = _arg.options;
        if (error == null) {
          _ref = this._storageEntriesMatching(proto, options), error = _ref[0], recordsAttributes = _ref[1];
        }
  ...
  Batman.RestStorage = (function() {
    ...
    RestStorage.prototype.request = function(options, callback) {
      options = $mixin(options, {
        ...
        error: __bind(function(error) {
          ...
          data = {
            error: error,
            response: error.request.get('response'),
            record: options.record
          };
          return this.runAfterFilter(options.action, data, callback);
        }, this)
    ...
    RestStorage.prototype.create = function(record, options, callback) {
      return this.runBeforeFilter('create', {
        record: record,
        options: options
      }, function(data) {
    ...
    RestStorage.prototype.update = function(record, options, callback) {
      return this.runBeforeFilter('update', {
        record: record,
        options: options
      }, function(data) {
    ...
    RestStorage.prototype.read = function(record, options, callback) {
      return this.runBeforeFilter('read', {
        record: record,
        options: options
      }, function(data) {
    ...
    events: {
      click: function(node, callback, context, eventName) {
        ...
        $addEventListener(node, eventName, function() {
          ...
          callback.apply(null, [node, context].concat(__slice.call(args)));
  ...
  Batman.DOM.EventBinding = (function() {
    ...
    function EventBinding(node, eventName, key, context) {
      ...
      callback = __bind(function() {
        ...
        return (_ref = this.get('filteredValue')) != null ? _ref.apply(context, arguments) : void 0;
      }, this);
