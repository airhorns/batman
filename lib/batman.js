(function() {
  ...
  Batman.Model = (function() {
    var doStorageMethod, k, _j, _len2, _ref2;
    ...
    Model.load = function(callback) {
      ...
      this.loading();
      return doStorageMethod.call(this, this.prototype, 'readAllFromStorage', __bind(function() {
        if (callback != null) {
    ...
    Model.accessor('identifier', {
      ...
      set: function(k, v) {
        return this.set(this.constructor.get('identifier'), v);
      }
    });
    ...
    doStorageMethod = function(target, methodName, callback) {
      var allMechanisms, fireImmediately, m, mechanisms, _k, _l, _len3, _len4;
    ...
    Model.prototype.load = function(callback) {
      this.loading();
      return doStorageMethod.call(this, this, 'readAllFromStorage', __bind(function() {
        this.loaded();
        return callback != null ? callback.call(this, this) : void 0;
      }, this));
    };
    Model.prototype.save = function(callback) {
      ...
      return doStorageMethod.call(this, this, 'writeToStorage', __bind(function() {
        if (creating) {
          this.created();
        }
        this.saved();
    ...
    Model.prototype.validate = function() {
      ...
      console.log(this.validating, this._batman.isTransitioning);
      this.validating();
      async = false;
  ...
  Batman.RestStorage = (function() {
    ...
    RestStorage.prototype.writeToStorage = function(record, callback, options) {
