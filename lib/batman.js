(function() {
  ...
  Batman.AssociationSet = (function() {
    ...
    AssociationSet.prototype._getLoadOptions = function() {
      var loadOptions;
      loadOptions = {};
      return loadOptions[this.association.foreignKey] = this.foreignKeyValue;
    };
  ...
  Batman.BelongsToAssociation = (function() {
    ...
    function BelongsToAssociation(model, label, options) {
      if ((options != null) && options.polymorphic) {
  ...
  Batman.PolymorphicBelongsToAssociation = (function() {
    ...
    PolymorphicBelongsToAssociation.prototype.setIndexForType = function(type) {
      var _base;
      (_base = this.typeIndicies)[type] || (_base[type] = new Batman.PolymorphicUniqueAssociationSetIndex(this, type, this.foreignKey));
  ...
  Batman.PolymorphicHasManyAssociation = (function() {
    ...
    PolymorphicHasManyAssociation.prototype.setIndex = function() {
      var type;
      if (!this.typeIndex) {
        type = $functionName(this.model);
        this.typeIndex = new Batman.PolymorphicAssociationSetIndex(this, type, this.foreignKey);
      }
