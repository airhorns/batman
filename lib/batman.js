(function() {
  var $block, $event, $eventOneShot, $findName, $mixin, $redirect, $route, $typeOf, $unmixin, Batman, camelize_rx, container, escapeRegExp, filters, helpers, matchContext, mixins, namedOrSplat, namedParam, queryParam, splatParam, underscore_rx1, underscore_rx2, _class, _class2, _objectToString;
  ...
  Batman.Property = (function() {
    ...
    Property.prototype.accessor = function() {
      ...
      return ((_ref = this.base._batman) != null ? (_ref2 = _ref.keyAccessors) != null ? _ref2.get(this.key) : void 0 : void 0) || ((_ref3 = this.base.constructor.prototype._batman) != null ? (_ref4 = _ref3.keyAccessors) != null ? _ref4.get(this.key) : void 0 : void 0) || ((_ref5 = this.base._batman) != null ? _ref5.defaultAccessor : void 0) || ((_ref6 = this.base.constructor.prototype._batman) != null ? _ref6.defaultAccessor : void 0) || Batman.Property.defaultAccessor;
    };
  ...
  */
  Batman.StateMachine = {
    initialize: function() {
      var _base;
      Batman._initializeObject(this);
      return (_base = this._batman).states || (_base.states = {});
    },
    state: function(name, callback) {
      ...
      event = this[name] || this.event(name, this, __bind(function() {
    ...
    setState: function(newState) {
      var event, name, oldState, _base, _i, _len, _ref, _ref2, _ref3;
      Batman.StateMachine.initialize.call(this);
      ...
      oldState = this._batman.state;
      this._batman.state = newState;
      if (newState && oldState) {
        name = "" + oldState + "->" + newState;
        _ref3 = [this._batman.states[name], (_ref = this.constructor.prototype._batman) != null ? (_ref2 = _ref.states) != null ? _ref2[name] : void 0 : void 0];
      ...
      setTimeout((__bind(function() {
        ...
        if ((_ref4 = this._batman.nextState) != null ? _ref4.length : void 0) {
          return this[this._batman.nextState.shift()]();
        }
      }, this)), 0);
      return newState;
    },
    currentState: function() {
      return this._batman.state;
    }
  };
    ...
    Object.accessor = function() {
      ...
      if (keys.length === 0) {
        ...
        for (_j = 0, _len = keys.length; _j < _len; _j++) {
          key = keys[_j];
          _results.push(this._batman.keyAccessors.set(key, accessor));
        }
        return _results;
      }
    };
