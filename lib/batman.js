(function() {
  ...
  Batman.View = (function() {
    ...
    View.accessor('yieldContents', function() {
      return Batman();
    });
  ...
  Batman.DOM = {
    readers: {
      ...
      contentfor: function(node, key) {
        $onParseExit(node, function() {
          return Batman.DOM.Yield.withName(key).append(node);
        });
        return true;
      },
      replace: function(node, key) {
        $onParseExit(node, function() {
          return Batman.DOM.Yield.withName(key).replace(node);
        });
        return true;
      }
    },
