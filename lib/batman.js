(function() {
  ...
  Batman._removeEventListener = $removeEventListener = (div = document.createElement('div')).removeEventListener ? function(elem, eventType, handler) {
    return elem.removeEventListener(eventType, handler, false);
  } : div.detachEvent ? function(elem, eventType, handler) {
