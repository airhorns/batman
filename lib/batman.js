(function() {
  ...
  Batman.Association = (function() {
    var AssociationSet, AssociationSetIndex;
    ...
    Association.prototype.getAccessor = function(self, model, label) {
      ...
      if (self.getRelatedModel()) {
        ...
        proxy = (_base2 = this._batman.associations)[_name = this.label] || (_base2[_name] = new self.proxyClass);
        if (proxy.get('proxyLoaded') !== true && self.options.autoload) {
          proxy.load(this, function() {});
        }
        return proxy;
      }
    };
    Association.prototype.defineProxyClass = function() {
      var association;
      association = this;
      return this.proxyClass || (this.proxyClass = (function() {
        __extends(_Class, this.getRelatedModel());
        function _Class() {
          _Class.__super__.constructor.apply(this, arguments);
        }
        _Class.prototype.load = function(baseModel, callback) {
          if (!callback) {
            callback = baseModel;
          } else {
            this.baseModel = baseModel;
          }
          return association.fetch(callback, this.baseModel, this);
        };
        return _Class;
      }).call(this));
    };
