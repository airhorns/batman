    ...
    View.observeAll('node', function(node) {
      ...
      if (node) {
        ...
        this._renderer.rendered(__bind(function() {
          debugger;          return this.ready(node);
        }, this));
        if (this.context) {
      ...
      foreach: function(node, iteratorName, key, context, parentRenderer) {
        ...
        context.bind(node, key, function(collection) {
          ...
          observers.add = function() {
            var item, items, iteratorContext, localClone, newNode, renderer, _j, _len2, _results;
            items = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
            _results = [];
            for (_j = 0, _len2 = items.length; _j < _len2; _j++) {
              item = items[_j];
              ...
              renderer = new Batman.Renderer(newNode, (function(newNode) {
                return function() {
              ...
              if (typeof renderer.rendered === "function") {
                renderer.rendered(function() {
                  return console.log('rendered listener fired!', this.node);
                });
              }
              _results.push(renderer);
            }
            return _results;
          };
