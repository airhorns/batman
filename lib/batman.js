(function() {
  var $block, $event, $eventOneShot, $findName, $mixin, $redirect, $route, $typeOf, $unmixin, Batman, Binding, RenderContext, Validators, camelize_rx, capitalize_rx, container, escapeRegExp, filters, helpers, mixins, namedOrSplat, namedParam, queryParam, splatParam, underscore_rx1, underscore_rx2, unmixinableKeys, _Batman, _class, _class2, _objectToString, _stateMachine_setState;
  var __slice = Array.prototype.slice, __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __indexOf = Array.prototype.indexOf || function(item) {
  ...
  Batman.mixin = $mixin = function() {
    ...
    for (_i = 0, _len = mixins.length; _i < _len; _i++) {
      ...
      for (key in mixin) {
        ...
        value = mixin[key];
        if (__indexOf.call(unmixinableKeys, key) >= 0) {
          continue;
        }
        if (hasSet) {
          to.set(key, value);
  ...
  RenderContext = (function() {
    ...
    RenderContext.prototype.findKey = function(key) {
      ...
      while (i--) {
        ...
        if (typeof val !== 'undefined') {
          return [(context.get || Batman.Observable.get).call(context, key), context];
        }
      }
