(function() {
  var $addEventListener, $appendChild, $clearImmediate, $contains, $destroyNode, $escapeHTML, $extendsEnumerable, $forEach, $forgetParseExit, $functionName, $get, $hasAddEventListener, $insertBefore, $isChildOf, $mixin, $objectHasKey, $onParseExit, $preventDefault, $redirect, $removeEventListener, $removeNode, $removeOrDestroyNode, $setImmediate, $setInnerHTML, $setStyleProperty, $trackBinding, $typeOf, $unmixin, Batman, BatmanObject, Validators, Yield, applySetAccessors, buntUndefined, camelize_rx, capitalize_rx, developer, div, filters, helpers, isEmptyDataObject, k, mixins, t, underscore_rx1, underscore_rx2, _Batman, _fn, _i, _implementImmediates, _j, _len, _len2, _objectToString, _ref, _ref2, _stateMachine_setState;
  ...
  Batman.View = (function() {
    ...
    View.directiveArgument = function() {
      ...
      return this.accessor.apply(this, __slice.call(keys).concat([function(key) {
        var _ref2;
        return (_ref2 = this.get(this._argumentBindingKey(key))) != null ? _ref2.get('filteredValue') : void 0;
      }]));
    };
    ...
    View.prototype.applyYields = function() {
      return this.get('yields').forEach(function(name, nodes) {
        var action, node, yield, _j, _len2, _ref2, _results;
        yield = Batman.DOM.Yield.withName(name);
        _results = [];
        for (_j = 0, _len2 = nodes.length; _j < _len2; _j++) {
          _ref2 = nodes[_j], node = _ref2.node, action = _ref2.action;
    ...
    View.prototype.retractYields = function() {
      return this.get('yields').forEach(function(name, nodes) {
        ...
        for (_j = 0, _len2 = nodes.length; _j < _len2; _j++) {
          node = nodes[_j].node;
          _results.push((_ref2 = node.parentNode) != null ? _ref2.removeChild(node) : void 0);
        }
        return _results;
      });
    };
  ...
  Batman.DOM = {
    ...
    attrReaders: {
      ...
      view: function(node, bindKey, contextKey, context) {
        ...
        return parent.observeAndFire(contextKey, function(newValue) {
          view || (view = Batman._data(node, 'view'));
    ...
    Yield: Yield = (function() {
      ...
      Yield.prototype.clear = Yield.queued(function() {
        ...
        _ref2 = Array.prototype.slice.call(this.containerNode.childNodes);
        _results = [];
        for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
          child = _ref2[_j];
    ...
    setInnerHTML: $setInnerHTML = function(node, html) {
      var child, childNodes, result, _j, _k, _len2, _len3;
      ...
      for (_k = 0, _len3 = childNodes.length; _k < _len3; _k++) {
        child = childNodes[_k];
    ...
    willInsertNode: function(node) {
      var child, view, _j, _len2, _ref2, _ref3;
      view = Batman._data(node, 'view');
      if (view != null) view.fire('beforeAppear', node);
      if ((_ref2 = Batman.data(node, 'show')) != null) _ref2.call(node);
    ...
    willRemoveNode: function(node) {
      ...
      if ((_ref2 = Batman.data(node, 'hide')) != null) _ref2.call(node);
      _ref3 = node.childNodes;
      for (_j = 0, _len2 = _ref3.length; _j < _len2; _j++) {
        child = _ref3[_j];
        Batman.DOM.willRemoveNode(child);
    ...
    didDestroyNode: function(node) {
      var bindings, child, eventListeners, eventName, listeners, view, _j, _len2, _ref2;
      view = Batman._data(node, 'view');
