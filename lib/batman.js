(function() {
  ...
  Batman.DOM = {
    ...
    trackBinding: $trackBinding = function(binding, node) {
      var bindings, current, parentBinding, parentBindings, _i, _len;
  ...
  Batman.DOM.SelectBinding = (function() {
    ...
    SelectBinding.prototype.dataChange = function(newValue) {
      var child, match, matches, value, valueToChild, was, _i, _j, _k, _len, _len2, _len3, _ref, _ref2;
      if (newValue instanceof Array) {
        ...
        console.log("setting to " + newValue + ", was " + was + " now " + this.node.value);
      }
