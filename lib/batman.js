...
(function() {
    ...
    Batman.Mixin.prototype = {
        ...
        applyTo: function(to) {
            ...
            Batman.execute(this.onapply, to); // FIXME: Should this just be an event?
        ...
        removeFrom: function(from) {
            ...
            Batman.execute(this.onremove, from);
    ...
    Batman.require(Batman.LIB_PATH + 'batman.mvc.js', Batman.ready);
