(function() {
  ...
  Batman.DOM.NodeAttributeBinding = (function() {
    ...
    NodeAttributeBinding.prototype.consturctor = function() {
      NodeAttributeBinding.__super__.consturctor.apply(this, arguments);
      if (this.attributeName === 'href') {
        return developer.warn("You should use a data-route binding instead of a data-bind-href on " + this.keyPath);
      }
    };
  ...
  Batman.DOM.RouteBinding = (function() {
    ...
    RouteBinding.prototype.bind = function() {
      ...
      return Batman.DOM.events.click(this.node, __bind(function() {
        return $redirect(this.get('filteredValue'));
      }, this));
    };
    RouteBinding.prototype.dataChange = function(value) {
      ...
      if ((path != null) && this.onATag) {
        return this.node.href = Batman.navigator.linkTo(path);
      }
    };
    return RouteBinding;
  })();
