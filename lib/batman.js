(function() {
  var $block, $event, $eventOneShot, $findName, $mixin, $redirect, $route, $typeOf, $unmixin, Batman, camelize_rx, container, escapeRegExp, filters, global, helpers, matchContext, mixins, namedOrSplat, namedParam, queryParam, splatParam, underscore_rx1, underscore_rx2, validators, _class, _class2, _objectToString, _stateMachine_setState;
  ...
  */
  ...
  Batman.Hash = (function() {
    ...
    Hash.prototype.clear = Batman.SimpleHash.prototype.clear;
    Hash.prototype.isEmpty = Batman.SimpleHash.prototype.isEmpty;
  ...
  Batman.Set = (function() {
    ...
    Set.prototype.add = Set.event(Batman.SimpleSet.prototype.add);
    Set.prototype.remove = Set.event(Batman.SimpleSet.prototype.remove);
    Set.prototype.each = Batman.SimpleSet.prototype.each;
    Set.prototype.isEmpty = Batman.SimpleSet.prototype.isEmpty;
    ...
    Set.prototype.clear = Batman.SimpleHash.prototype.clear;
  ...
  Batman.Model = (function() {
    ...
    Model.prototype.state('empty');
    Model.prototype.state('dirty');
    Model.prototype.state('loading');
    Model.prototype.state('loaded');
    Model.prototype.state('saving');
    ...
    Model.prototype.toJSON = function() {
      var encoder, encoders, key, obj, _i, _len, _ref;
      obj = {};
      _ref = Batman._lookupAllBatmanKeys(this, 'encoders');
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        encoders = _ref[_i];
        for (key in encoders) {
    ...
    Model.prototype.fromJSON = function(data) {
      var allDecoders, decoder, decoders, key, obj, value, _i, _len;
      obj = {};
      ...
      if (!allDecoders.length) {
        ...
        for (_i = 0, _len = allDecoders.length; _i < _len; _i++) {
          decoders = allDecoders[_i];
          for (key in decoders) {
    ...
    Model.load = function() {
      var allMechanisms, callback, fireImmediately, m, mechanisms, _i, _j, _len, _len2;
      this.beforeLoad();
      ...
      for (_i = 0, _len = allMechanisms.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len2 = mechanisms.length; _j < _len2; _j++) {
          m = mechanisms[_j];
          m.readAllFromStorage(this, callback);
        }
      }
      if (fireImmediately) {
        return callback();
    ...
    Model.prototype.load = function() {
      ...
      for (_i = 0, _len = allMechanisms.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len2 = mechanisms.length; _j < _len2; _j++) {
          m = mechanisms[_j];
          m.readFromStorage(this, callback);
        }
      }
      if (fireImmediately) {
        return callback();
    ...
    Model.prototype.save = function() {
      var allMechanisms, callback, creating, fireImmediately, m, mechanisms, _i, _j, _len, _len2;
      if (!this.isValid()) {
        return;
      }
      this.beforeSave();
      ...
      for (_i = 0, _len = allMechanisms.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len2 = mechanisms.length; _j < _len2; _j++) {
          m = mechanisms[_j];
          m.writeToStorage(this, callback);
        }
      }
      if (fireImmediately) {
        return callback();
    ...
    Model.prototype.validate = function() {
      var allValidators, async, key, promise, v, validator, _i, _j, _k, _len, _len2, _len3, _ref, _ref2;
      this.beforeValidation();
      async = false;
      _ref = Batman._lookupAllBatmanKeys(this, 'validators');
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        allValidators = _ref[_i];
        for (_j = 0, _len2 = allValidators.length; _j < _len2; _j++) {
          validator = allValidators[_j];
    ...
    Model.validate = function() {
      var keys, match, matches, myValidators, options, validator, _base, _i, _j, _len, _results;
      keys = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), options = arguments[_i++];
      Batman._initializeObject(this.prototype);
  ...
  global = typeof window !== "undefined" && window !== null ? window : exports;
