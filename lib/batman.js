(function() {
  ...
  Batman.Model = (function() {
    ...
    Model._mapIdentities = function(records) {
      var all, existingRecord, newRecords, potential, record, _ref2;
      all = this.get('all').toArray();
      newRecords = [];
      records = (function() {
        var _j, _k, _len2, _len3, _results;
        _results = [];
        for (_j = 0, _len2 = records.length; _j < _len2; _j++) {
          ...
          _results.push(existingRecord ? existingRecord : (newRecords.push(record), record));
        }
        return _results;
      })();
