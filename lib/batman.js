(function() {
  ...
  Batman.DOM = {
    ...
    setInnerHTML: $setInnerHTML = function() {
      var args, child, childNodes, html, node, _j, _k, _len2, _len3, _results;
