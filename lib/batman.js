  ...
  Batman.HashHistory = (function() {
    ...
    HashHistory.prototype.start = function() {
      ...
      if ('onhashchange' in window) {
        Batman.DOM.addEventListener(window, 'hashchange', this.parseHash);
      } else {
