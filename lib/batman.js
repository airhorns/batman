(function() {
  /*
  batman
  */  var $bind, $event, $mixin, Batman, camelize_rx, global, helpers, isFunction, toString, typeOf, underscore_rx1, underscore_rx2;
  ...
  typeOf = Batman.typeOf = function(obj) {
  ...
  $event = Batman.event = function(original) {
    ...
    f = function(handler) {
      ...
      if (typeOf(handler) === 'Function') {
        if (f.oneShot && (f.lastFire != null)) {
          handler.apply(this, f.lastFire);
        } else {
  ...
  Batman.Observable = {
    ...
    get: function(key) {
      ...
      value = this[key];
      if (value != null ? value.isProperty : void 0) {
        return this[key]();
    ...
    set: function(key, value) {
      var FIXME_firstObject, FIXME_lastPath, i, index, l, oldValue, results, _ref;
      ...
      if ((_ref = this[key]) != null ? _ref.isProperty : void 0) {
        ...
        if (oldValue !== value) {
          ...
          if (typeof oldValue === 'undefined') {
            value = this.methodMissing(key, value);
          } else {
            this[key] = value;
          }
        }
    ...
    fire: function(key, value, oldValue) {
      var callback, observers, _i, _j, _len, _len2, _ref, _ref2;
      _ref2 = [this._observers[key], (_ref = this.constructor.prototype._observers) != null ? _ref[key] : void 0];
  ...
  Batman.Deferred = (function() {
    function Deferred(original) {
      ...
      this.success = $event.oneShot(original);
      this.failure = $event.oneShot(original);
      this.all = $event.oneShot(original);
      this.resolved = false;
      this.rejected = false;
    }
  ...
  Batman.Object = (function() {
    ...
    function Object() {
      ...
      for (key in this) {
        ...
        if (value && value.isProperty) {
          ...
          value.observe = __bind(function(observer) {
    ...
    Batman.mixin(Object, Batman.Observable);
  ...
  Batman.App = (function() {
    ...
    App._require = function() {
      ...
      for (_i = 0, _len = names.length; _i < _len; _i++) {
        ...
        new Batman.Request({
          type: 'html',
          url: "" + (this.baseUrl || '') + path + "/" + name + ".coffee"
    ...
    App.app = function() {
      ...
      for (_i = 0, _len = names.length; _i < _len; _i++) {
        name = names[_i];
        _results.push(this._require("apps/" + name, name));
      }
      return _results;
    };
    ...
    App.run = function() {
      var app;
      if (typeof SharedApp !== "undefined" && SharedApp !== null) {
  ...
  Batman.View = (function() {
    ...
    View.prototype.observe('source', function(path) {
      if (path) {
  ...
  Batman.Request = (function() {
    ...
    Request.prototype.observe('url', function() {
      return setTimeout($bind(this, this.send), 0);
    });
    Request.prototype.send = function(data) {
      ...
      this._request = Batman.Modules.reqwest(options);
      return this;
    };
  ...
  Batman.JSONPRequest = (function() {
    ...
    JSONPRequest.prototype.send = function(data) {
      return Batman.Modules.JSONP.get(this.get('url'), this.get('data') || {}, __bind(function(data) {
