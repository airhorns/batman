(function() {
  ...
  Batman.Association = (function() {
    ...
    Association.prototype.getRelatedModel = function(scope) {
      var modelName;
      if (scope == null) {
        scope = Batman.currentApp;
      }
      modelName = helpers.camelize(helpers.singularize(this.label));
  ...
  Batman.Association.hasOne = (function() {
    ...
    hasOne.prototype.getAccessor = function(self, model, label) {
      var existingInstance, id, loadOptions, loadedRecord, modelName, relatedModel, relatedModelName, relatedRecords;
      if (this.amSetting) {
        return;
      }
  ...
  Batman.Association.hasMany = (function() {
    ...
    hasMany.prototype.decodeObjectIntoModel = function(model, obj, data) {
      var id, idRegex, json, record, relatedModel, relations, storageKey, _, _ref;
      if (json = data[this.label]) {
