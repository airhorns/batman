            ...
            if (associations) {
              if (hasOne = associations.hasOne) {
                hasOne.forEach(__bind(function(key) {
                  var foreignKey, model, _ref4;
                  if (model = (_ref4 = record._batman.attributes) != null ? _ref4[key] : void 0) {
              ...
              if (hasMany = associations.hasMany) {
                hasMany.forEach(__bind(function(key) {
                  var hasManySet, _ref4;
                  if (hasManySet = (_ref4 = record._batman.attributes) != null ? _ref4[key] : void 0) {
