(function() {
    ...
    App.run = function() {
      ...
      if (typeof this.historyManager === 'undefined' && this.dispatcher.routeMap) {
        this.on('run', __bind(function() {
          this.historyManager = Batman.historyManager = Batman.HistoryManager.forApp(this);
  ...
  Batman.HistoryManager = (function() {
    HistoryManager.forApp = function(app) {
      return app.historyManager || new this.defaultClass(app);
    };
    function HistoryManager(app) {
      this.app = app;
      this.handleCurrentURL = __bind(this.handleCurrentURL, this);
    }
    HistoryManager.prototype.start = function() {
      ...
      return $setImmediate(__bind(function() {
        ...
        return Batman.currentApp.fire('ready');
      }, this));
    };
    ...
    HistoryManager.prototype.handleCurrentURL = function() {
      var url;
      url = this.getCurrentURL();
      if (url === this.cachedURL) {
        return;
      }
      return this.dispatch(this.cachedURL = url);
    };
    HistoryManager.prototype.dispatch = function(url) {
      url = this.joinPath('/', url);
    ...
    HistoryManager.prototype.redirect = function(url) {
      ...
      return this.cachedURL = this.dispatch(url);
    };
    HistoryManager.prototype.joinPath = function() {
      var i, seg, segments;
  ...
  Batman.StateHistory = (function() {
    __extends(StateHistory, Batman.HistoryManager);
    function StateHistory() {
      StateHistory.__super__.constructor.apply(this, arguments);
    }
    StateHistory.isSupported = function() {
      var _ref;
      return (typeof window !== "undefined" && window !== null ? (_ref = window.history) != null ? _ref.pushState : void 0 : void 0) != null;
    };
    StateHistory.prototype.startWatching = function() {
      return $addEventListener(window, 'popstate', this.handleCurrentURL);
    };
    StateHistory.prototype.stopWatching = function() {
      return $removeEventListener(window, 'popstate', this.handleCurrentURL);
    };
    StateHistory.prototype.urlFor = function(url) {
      var result;
      result = this.joinPath('/', Batman.pathPrefix, url);
      return result;
    };
    StateHistory.prototype.getCurrentURL = function() {
      var fullPath, prefixPattern, result;
      fullPath = window.location.pathname + window.location.search;
      prefixPattern = new RegExp("^" + (this.joinPath('/', Batman.pathPrefix)));
      result = fullPath.replace(prefixPattern, '');
      return result;
    };
    StateHistory.prototype.redirect = function(params) {
      var url;
      url = StateHistory.__super__.redirect.apply(this, arguments);
      return window.history.pushState(null, '', this.urlFor(url));
    };
    return StateHistory;
  })();
  Batman.HashHistory = (function() {
    ...
    if ((typeof window !== "undefined" && window !== null) && 'onhashchange' in window) {
      HashHistory.prototype.startWatching = function() {
        return $addEventListener(window, 'hashchange', this.handleCurrentURL);
      };
      HashHistory.prototype.stopWatching = function() {
        return $removeEventListener(window, 'hashchange', this.handleCurrentURL);
      };
    } else {
      HashHistory.prototype.startWatching = function() {
        return this.interval = setInterval(this.handleCurrentURL, 100);
      };
      HashHistory.prototype.stopWatching = function() {
    ...
    HashHistory.prototype.getCurrentURL = function() {
      return window.location.hash.replace(this.HASH_PREFIX, '');
    };
    HashHistory.prototype.redirect = function(params) {
      var url;
      url = HashHistory.__super__.redirect.apply(this, arguments);
      return window.location.hash = this.urlFor(url);
    };
    return HashHistory;
  })();
  Batman.HistoryManager.defaultClass = Batman.StateHistory.isSupported() ? Batman.StateHistory : Batman.HashHistory;
  ...
  Batman.ViewSourceCache = (function() {
    ...
    ViewSourceCache.accessor({
      get: function(path) {
        path = Batman.HistoryManager.prototype.joinPath('/', path);
  ...
  Batman.View = (function() {
    ...
    View.accessor('html', function() {
      ...
      path = Batman.HistoryManager.prototype.joinPath('/', this.prefix, source);
    ...
    readers: {
      ...
      route: function(node, key, context) {
        ...
        if (node.nodeName.toUpperCase() === 'A') {
          node.href = Batman.HistoryManager.defaultClass.prototype.urlFor(url);
        }
  ...
  Batman.DOM.ClassBinding = (function() {
    __extends(ClassBinding, Batman.DOM.AbstractAttributeBinding);
    ...
    ClassBinding.prototype.nodeChange = function(node, subContext) {
      if (this.key) {
        return subContext.set(this.key, node.className);
      }
    };
    return ClassBinding;
  })();
  ...
  Batman.DOM.EventBinding = (function() {
    ...
    function EventBinding() {
      ...
      Batman.DOM.events[this.attributeName](this.node, __bind(function() {
        var _ref;
  ...
  Batman.DOM.StyleBinding = (function() {
    __extends(StyleBinding, Batman.DOM.AbstractAttributeBinding);
    ...
    function StyleBinding() {
      ...
      this.onItemsAdded = __bind(this.onItemsAdded, this);      this.oldStyles = {};
      StyleBinding.__super__.constructor.apply(this, arguments);
    }
    StyleBinding.prototype.destroy = function() {
      StyleBinding.__super__.destroy.apply(this, arguments);
      return this.unbindCurrentHash();
    };
    StyleBinding.prototype.dataChange = function(value) {
      ...
      if (value instanceof Batman.Hash && (this.boundValueType = 'batman.hash')) {
        ...
        return value.keys().forEach(__bind(function(key) {
          return this.onItemsAdded(key);
        }, this));
      } else if (value instanceof Object && (this.boundValueType = 'object')) {
        this.reapplyOldStyles();
        _results = [];
        for (key in value) {
    ...
    StyleBinding.prototype.onItemsAdded = function(newKey) {
      return this.setStyle(newKey, this.styleHash.get(newKey));
    };
    StyleBinding.prototype.onItemsRemoved = function(oldKey) {
    ...
    StyleBinding.prototype.unbindCurrentHash = function() {
      if (this.styleHash) {
  ...
  Batman.DOM.IteratorBinding = (function() {
    __extends(IteratorBinding, Batman.DOM.AbstractAttributeBinding);
    ...
    IteratorBinding.prototype.arrayChanged = function() {
