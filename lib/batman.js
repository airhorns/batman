(function() {
  ...
  */
  ...
  Batman.Trigger = (function() {
    ...
    Trigger.prototype.isValid = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (!(targetBase = targetBase != null ? targetBase[segment] : void 0)) {
          return false;
        }
      }
    };
  ...
  Batman.TriggerSet = (function() {
    ...
    TriggerSet.prototype.removeInvalidTriggers = function() {
      var trigger, _i, _len, _ref, _results;
      _ref = this.triggers.slice();
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        trigger = _ref[_i];
        _results.push(!trigger.isValid() ? trigger.remove() : void 0);
      }
      return _results;
    };
    return TriggerSet;
