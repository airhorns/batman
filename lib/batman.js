(function() {
  ...
  Batman.App = (function() {
    ...
    App.classAccessor('paramsManager', {
      get: function() {
        ...
        return params.manager = new Batman.ParamsManager(nav, params);
      },
      final: true
    });
  ...
  Batman.ParamsManager = (function() {
    __extends(ParamsManager, Batman.Object);
    function ParamsManager(navigator, params) {
      this.navigator = navigator;
      this.params = params;
    }
    ParamsManager.prototype.redirect = function() {
      return this.navigator.replace(this.toObject());
    };
    ParamsManager.prototype.replace = function(params) {
      this.params.replace(params);
      return this.redirect();
    };
    ParamsManager.prototype.update = function(params) {
      this.params.update(params);
      return this.redirect();
    };
    ParamsManager.prototype.clear = function() {
      this.params.clear();
      return this.redirect();
    };
    ParamsManager.prototype.toObject = function() {
      return this.params.toObject();
    };
    ParamsManager.accessor({
      get: function(k) {
  ...
  Batman.ParamsPusher = (function() {
    __extends(ParamsPusher, Batman.ParamsManager);
  ...
  Batman.Association.belongsTo = (function() {
    ...
    belongsTo.prototype.proxyClass = Batman.BelongsToProxy;
  ...
  Batman.Association.hasOne = (function() {
    ...
    hasOne.prototype.proxyClass = Batman.HasOneProxy;
    function hasOne() {
