(function() {
  ...
  */  var $event, $eventOneShot, $mixin, $redirect, $route, $typeOf, $unmixin, Batman, camelize_rx, escapeRegExp, filters, global, helpers, matchContext, namedOrSplat, namedParam, splatParam, underscore_rx1, underscore_rx2, _objectToString;
  ...
  */
  ...
  Batman.DOM = {
    ...
    attrReaders: {
      ...
      foreach: function(node, attr, key, contexts) {
        var context;
        context = matchContext(contexts, key);
        return context;
      }
