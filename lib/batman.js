(function() {
  var $block, $event, $eventOneShot, $findName, $mixin, $redirect, $route, $typeOf, $unmixin, Batman, Validators, camelize_rx, container, escapeRegExp, filters, helpers, matchContext, mixins, namedOrSplat, namedParam, queryParam, splatParam, underscore_rx1, underscore_rx2, _Batman, _class, _class2, _objectToString, _stateMachine_setState;
  ...
  */
  ...
  Batman.StorageMechanism = (function() {
    ...
    StorageMechanism.makesStorageAdapters = true;
