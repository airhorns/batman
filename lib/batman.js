(function() {
  ...
  Batman.AssociationProxy = (function() {
    ...
    AssociationProxy.prototype.load = function(callback) {
      this.association.fetch(this, __bind(function(err, relation) {
  ...
  Batman.Association.belongsTo = (function() {
    ...
    belongsTo.prototype.fetch = function(proxy, callback) {
      var loadedRecords, relatedID;
      if (relatedID = proxy.model.get("" + this.label + "_id")) {
  ...
  Batman.Association.hasOne = (function() {
    ...
    hasOne.prototype.fetch = function(proxy, callback) {
