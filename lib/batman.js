(function() {
  ...
  */
  Batman.TriggerSet = (function() {
    ...
    TriggerSet.prototype.fireAll = function(oldValue) {
      var depth, keypath, pathToTargetOldValue, targetNewValue, targetOldValue, trigger, _i, _len, _ref, _results;
      _ref = this.triggers;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        pathToTargetOldValue.eachPair(function(minimalKeypath, index) {
          var triggerSet, _ref2, _ref3;
          if (triggerSet = (_ref2 = minimalKeypath.base._batman) != null ? (_ref3 = _ref2.outboundTriggers) != null ? _ref3[minimalKeypath.segments[0]] : void 0 : void 0) {
            return triggerSet.remove(keypath, depth + index + 1);
          }
        });
        keypath.base._populateTriggers(keypath, depth);
        targetOldValue = pathToTargetOldValue.resolve();
        targetNewValue = keypath.resolve();
        _results.push(keypath.base.fire(keypath.path(), targetNewValue, targetOldValue));
      }
      return _results;
    };
    return TriggerSet;
  ...
  */
  Batman.Observable = {
    ...
    fire: function(key, value, oldValue) {
      var args, callback, observers, triggerSet, _i, _j, _len, _len2, _ref, _ref2, _ref3;
      if (!this.allowed(key)) {
        return;
      }
      Batman.Observable.initialize.call(this);
