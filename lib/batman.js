(function() {
  ...
  Batman.DOM = {
    ...
    propagateBindingEvents: $propagateBindingEvents = function(newNode) {
      var binding, bindings, child, _i, _j, _len, _len2, _ref;
      ...
      if (bindings = Batman._data(newNode, 'bindings')) {
        for (_j = 0, _len2 = bindings.length; _j < _len2; _j++) {
          binding = bindings[_j];
  ...
  Batman.DOM.AbstractBinding = (function() {
    ...
    AbstractBinding.prototype._fireNodeChange = function() {
      ...
      if (typeof this.nodeChange === "function") this.nodeChange(this.node, val);
  ...
  Batman.DOM.SelectBinding = (function() {
    ...
    function SelectBinding() {
      ...
      this.childBindingAdded = __bind(this.childBindingAdded, this);      this.selectedBindings = new Batman.SimpleSet;
    ...
    SelectBinding.prototype.dataChange = function(newValue) {
      ...
      var _this = this;
      if ((newValue != null) && newValue.forEach) {
        valueToChild = {};
        ...
        newValue.forEach(function(value) {
          var children, node, _j, _len2, _results;
  ...
  Batman.DOM.FormBinding = (function() {
    ...
    function FormBinding(node, contextName, keyPath, renderContext, renderer, only) {
      this.childBindingAdded = __bind(this.childBindingAdded, this);      FormBinding.__super__.constructor.apply(this, arguments);
