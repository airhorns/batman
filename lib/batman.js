(function() {
    ...
    Route.accessor('action', {
      get: function() {
        ...
        if (this.signature) {
          ...
          target = this.dispatcher.get(components[0]);
          return this.set('action', [components[0], components[1], target]);
        }
      },
  ...
  Batman.Dispatcher = (function() {
    ...
    Dispatcher.prototype.findUrl = function(params) {
      var action, controller, key, route, url, value, _ref2, _ref3;
      _ref2 = this.routeMap;
      for (url in _ref2) {
        route = _ref2[url];
        ...
        _ref3 = action, controller = _ref3[0], action = _ref3[1];
    ...
    Dispatcher.prototype.dispatch = function(url) {
      var _ref2;
      return (_ref2 = this.findRoute(url)) != null ? _ref2.dispatch(url) : void 0;
    };
    return Dispatcher;
  })();
