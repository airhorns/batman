(function() {
  ...
  Batman.RestStorage = (function() {
    ...
    RestStorage.prototype.request = function(env, callback) {
      var options, req;
      if (env.error != null) {
    ...
    RestStorage.prototype.before('all', RestStorage.skipIfError(function(env, next) {
      $mixin((env.options || (env.options = {})), this.defaultRequestOptions);
      return next();
    }));
    ...
    RestStorage.prototype.readAll = function(proto, options, callback) {
      return this.runBeforeFilter('readAll', {
        ...
        env.options.method = this.constructor.HTTPMethods['readAll'];
        return this.request(env, callback);
      });
    };
    return RestStorage;
