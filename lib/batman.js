(function() {
  ...
  Batman.Model = (function() {
    ...
    _ref2 = ['empty', 'dirty', 'loading', 'loaded', 'saving', 'creating', 'created', 'validated', 'destroying', 'destroyed'];
    for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
      k = _ref2[_j];
      Model.state(k);
    }
    ...
    Model.prototype.load = function(callback) {
      var _ref3;
      if ((_ref3 = this.get('state')) === 'destroying' || _ref3 === 'distroyed') {
        if (typeof callback === "function") {
    ...
    Model.prototype.validate = function(callback, errors) {
      var count, key, v, validationCallback, validator, validators, _k, _l, _len3, _len4, _ref3;
      if (errors == null) {
  ...
  Batman.LocalStorage = (function() {
    ...
    function LocalStorage() {
      var k, matches, re, v, _ref2;
      if (typeof window.localStorage === 'undefined') {
        return null;
      }
      LocalStorage.__super__.constructor.apply(this, arguments);
      this.storage = localStorage;
      re = new RegExp("$" + this.modelKey + "(\d+)");
      this.nextId = 1;
      _ref2 = this.storage;
      for (k in _ref2) {
        v = _ref2[k];
        if (matches = re.exec(k)) {
          this.nextId = Math.max(this.nextId, parseInt(matches[1], 10));
        }
      }
      return;
    }
    ...
    LocalStorage.prototype.readAll = function(_, options, callback) {
      var data, k, match, records, storageKey, v, _ref2;
      records = [];
      _ref2 = this.storage;
