(function() {
  ...
  Batman.Model = (function() {
    ...
    Model.prototype.save = function(callback) {
      ...
      return this.validate(__bind(function(isValid, errors) {
        ...
        modelSaved.prevent();
        if (callback) {
          modelSaved.addHandler(callback);
        }
  ...
  Batman.Association.hasMany = (function() {
    ...
    hasMany.prototype.addEncoder = function() {
      ...
      return this.model.encode(this.label, {
        decode: __bind(function(data) {
          var id, idRegex, model, obj, relations, storageKey, _, _ref, _ref2;
          if (typeof data === "string") {
            this.model._readingFromJSON = true;
            relations = new Batman.Set;
            idRegex = new RegExp("^" + ($functionName(this.relatedModel).toLowerCase()) + "s(\\d+)$");
            _ref = JSON.parse(data);
            for (storageKey in _ref) {
              if (!__hasProp.call(_ref, storageKey)) continue;
              obj = _ref[storageKey];
              _ref2 = storageKey.match(idRegex), _ = _ref2[0], id = _ref2[1];
