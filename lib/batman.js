  ...
  Batman.DOM.Iterator = (function() {
    ...
    Iterator.prototype.collectionChange = function(newCollection) {
      ...
      if (this.collection) {
        ...
        if (this.collection.isObservble) {
      ...
      if (this.collection) {
        if (this.collection.isObservable) {
