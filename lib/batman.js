(function() {
  ...
  Batman.RenderCache = (function() {
    ...
    RenderCache.prototype.unset = function(key) {
      var val;
      val = RenderCache.__super__.unset.apply(this, arguments);
  ...
  Batman.View = (function() {
    ...
    YieldStorage = (function() {
      ...
      YieldStorage.accessor($mixin({}, Batman.Hash.defaultAccessor, {
        get: function(k) {
          var val;
          val = Batman.Hash.defaultAccessor.get.call(this, k);
          if (!(val != null)) val = this.set(k, []);
          return val;
        }
      }));
  ...
  Batman.DOM = {
    readers: {
      ...
      yield: function(node, key) {
        $onParseExit(node, function() {
          return Batman.DOM.Yield.withName(key).set('destinationNode', node);
        });
        return true;
      },
      contentfor: function(node, key, context, renderer, action) {
        ...
        $onParseExit(node, function() {
          return renderer.view.get("yields." + key).push({
            node: node,
            action: action
          });
        });
    ...
    Yield: Yield = (function() {
      ...
      Yield.queued = function(fn) {
        return function() {
          ...
          if (this.destinationNode != null) {
            ...
            return handler = this.observe('destinationNode', function() {
              var result;
              result = fn.apply(_this, args);
              _this.forget('destinationNode', handler);
              return result;
            });
          }
        };
      ...
      Yield.detachQueued = function(fn) {
        var queuer;
        queuer = this.queued(fn);
        return function(node) {
          var _ref;
          if (node != null) {
            if ((_ref = node.parentNode) != null) _ref.removeChild(node);
          }
          return queuer.apply(this, arguments);
        };
      };
      ...
      Yield.prototype.clear = Yield.queued(function() {
        return $setInnerHTML(this.destinationNode, '', true);
      });

      Yield.prototype.append = Yield.detachQueued(function(node) {
        return $appendChild(this.destinationNode, node, true);
      });

      Yield.prototype.replace = Yield.detachQueued(function(node) {
        this.clear();
    ...
    setInnerHTML: $setInnerHTML = function() {
      var args, child, childNodes, html, node, _i, _j, _len, _len2, _results;
      ...
      for (_j = 0, _len2 = childNodes.length; _j < _len2; _j++) {
        child = childNodes[_j];
        _results.push(Batman.DOM.didRemoveNode(child));
      }
      return _results;
    },
    ...
    didInsertNode: function(node) {
      ...
      view = Batman.data(node, 'view');
      if (view != null) view.fire('appear', node);
