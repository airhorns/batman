(function() {
  var $block, $event, $eventOneShot, $findName, $mixin, $redirect, $route, $typeOf, $unmixin, Batman, Binding, RenderContext, Validators, buntUndefined, camelize_rx, capitalize_rx, container, escapeRegExp, filters, helpers, mixins, namedOrSplat, namedParam, queryParam, splatParam, underscore_rx1, underscore_rx2, unmixinableKeys, _Batman, _class, _objectToString, _stateMachine_setState;
  ...
  Batman.DOM = {
    ...
    attrReaders: {
      ...
      foreach: function(node, iteratorName, key, context, parentRenderer) {
        var add, addItem, collection, k, nodeMap, parent, prototype, remove, sibling, v;
