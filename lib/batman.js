(function() {
  var $block, $event, $eventOneShot, $findName, $get, $mixin, $redirect, $route, $typeOf, $unmixin, Batman, Binding, RenderContext, Validators, buntUndefined, camelize_rx, capitalize_rx, container, escapeRegExp, filters, helpers, k, mixins, namedOrSplat, namedParam, queryParam, splatParam, underscore_rx1, underscore_rx2, unmixinableKeys, _Batman, _class, _fn, _i, _j, _len, _len2, _objectToString, _ref, _ref2, _stateMachine_setState;
  ...
  */
  ...
  Binding = (function() {
    ...
    get_rx = /(\w)\[(.+?)\]/;
    Binding.accessor('filteredValue', {
      get: function() {
        var value;
    ...
    Binding.accessor('unfilteredValue', {
      get: function() {
        if (this.get('key')) {
  ...
  Batman.DOM = {
    ...
    attrReaders: {
      ...
      foreach: function(node, iteratorName, key, context, parentRenderer) {
        var add, nodeMap, parent, prototype, remove, sibling;
