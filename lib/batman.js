(function() {
  ...
  Batman.StateMachine = (function() {
    ...
    StateMachine.transitions = function(table) {
      ...
      _fn = function(k) {
        var _base;
        return (_base = _this.prototype)[k] || (_base[k] = function(suggestedNextState) {
  ...
  Batman.Model = (function() {
    ...
    Model.prototype.load = function(options, callback) {
      ...
      if ((_ref2 = this.lifecycle.get('state')) === 'destroying' || _ref2 === 'destroyed') {
    ...
    Model.prototype.save = function(callback) {
      ...
      return this.validate(function(error, errors) {
        var associations, creating, _ref2;
        if (error || errors.length) {
          if (typeof callback === "function") callback(error || errors);
          return;
        }
        creating = _this.isNew();
        if (_this.lifecycle["do"](creating ? 'create' : 'save')) {
          associations = _this.constructor._batman.get('associations');
          if (associations != null) {
            if ((_ref2 = associations.getByType('belongsTo')) != null) {
              _ref2.forEach(function(association, label) {
          ...
          return _this._doStorageOperation((creating ? 'create' : 'update'), {}, function(err, record) {
            if (!err) {
              _this.lifecycle["do"](creating ? 'created' : 'saved');
            ...
            _this.lifecycle.doneStore();
            return typeof callback === "function" ? callback(err, record) : void 0;
          });
        } else {
          return typeof callback === "function" ? callback(new Batman.StateMachine.InvalidTransitionError("Can't save while in state " + (_this.lifecycle.get('state')))) : void 0;
        }
      });
    };

    Model.prototype.destroy = function(optiosn, callback) {
      var options, _ref;
      var _this = this;
      if (!callback) _ref = [{}, options], options = _ref[0], callback = _ref[1];
    ...
    Model.prototype.validate = function(callback) {
      ...
      if (this.lifecycle.validate()) {
        finish = function() {
          if (_this.errors.get('length') === 0) {
            _this.lifecycle.validated();
            _this.lifecycle.doneValidation(oldState);
            return typeof callback === "function" ? callback(void 0, _this.errors) : void 0;
          } else {
            _this.lifecycle.invalidate(oldState);
            return typeof callback === "function" ? callback(void 0, _this.errors) : void 0;
          }
        };
