(function() {
  ...
  Batman.Model = (function() {
    ...
    Model.prototype.relationURL = function(keypath) {
      var base, key, url, _j, _len2, _ref2;
      url = Batman.RestStorage.prototype.urlForRecord(this);
      base = this;
      _ref2 = keypath.split('.');
      for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
        key = _ref2[_j];
        base = base.get(key);
        url += typeof base.url === 'function' ? base.url() : Batman.RestStorage.prototype.urlForRecord(base);
      }
      return url;
    };
    Model.accessor('id', {
  ...
  Batman.AssociationProxy = (function() {
    ...
    AssociationProxy.prototype.url = function() {
      var record;
      record = this.get('target');
      return Batman.RestStorage.prototype.urlForRecord(record);
    };
  ...
  Batman.RestStorage = (function() {
      ...
      if (record.url) {
        ...
        if (data.action !== 'create') {
          if ((id = record.get('id')) != null) {
            ...
            throw new this.constructor.StorageError("Couldn't get/set record primary key on " + data.action + "!");
          }
        }
      }
      return url;
    ...
    RestStorage.prototype.urlForCollection = function(model, data) {
      if (model.url) {
        return this._execWithOptions(model, 'url', data.options);
      } else {
        return this._defaultCollectionUrl(model.prototype, data.options);
      }
    };
    ...
    RestStorage.prototype.before('create', 'read', 'update', 'destroy', RestStorage.skipIfError(function(data, next) {
      try {
        data.url = this.urlForRecord(data.record, data);
      } catch (error) {
        return next(error);
      }
      return next();
    ...
    RestStorage.prototype.before('readAll', RestStorage.skipIfError(function(data, next) {
      try {
        data.url = this.urlForCollection(data.proto.constructor, data);
      } catch (error) {
        return next(error);
      }
      return next();
