(function() {
  var $block, $event, $eventOneShot, $findName, $mixin, $redirect, $route, $typeOf, $unmixin, Batman, Binding, RenderContext, Validators, camelize_rx, capitalize_rx, container, escapeRegExp, filters, helpers, mixins, namedOrSplat, namedParam, queryParam, splatParam, underscore_rx1, underscore_rx2, _class, _class2, _objectToString, _stateMachine_setState;
  ...
  Batman.DOM = {
    ...
    attrReaders: {
      ...
      foreach: function(node, iteratorName, key, context, parentRenderer) {
        var add, collection, nodeMap, parent, prototype, remove;
