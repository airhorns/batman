(function() {
  ...
  Batman.Controller = (function() {
    ...
    Controller.prototype.dispatch = function(action, params) {
      var filter, filters, oldRedirect, preventRender, _j, _k, _len2, _len3, _ref2, _ref3, _ref4, _ref5, _ref6;
      if (params == null) {
        params = {};
      }
      ...
      preventRender = !this[action](params);
      if (!this._actedDuringAction && !preventRender) {
        this.render();
      }
