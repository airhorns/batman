(function() {
  var $block, $event, $eventOneShot, $findName, $mixin, $redirect, $route, $typeOf, $unmixin, Batman, camelize_rx, container, escapeRegExp, filters, global, helpers, matchContext, mixins, namedOrSplat, namedParam, queryParam, splatParam, underscore_rx1, underscore_rx2, _class, _class2, _objectToString;
