(function() {
  ...
  Batman.Association = (function() {
    ...
    Association.prototype.encodeModelIntoObject = function() {
      return developer.error("You must override encodeModelIntoObject in Batman.Association subclasses.");
    };
    ...
    hasOne.prototype.encoder = function() {
      ...
      return {
        encode: function(val) {
          ...
          relationJSON[this.foreignKey] = this.get('id');
          return val.toJSON();
        },
        decode: function(data) {
          var record;
  ...
  Batman.DOM.IteratorBinding = (function() {
          ...
          (_base2 = this.actions)[_name2 = options.actionNumber] || (_base2[_name2] = function() {
            ...
            if (typeof show === 'function') {
              ...
              if (options.fragment) {
                ...
                $insertBefore(this.parentNode, node, nextSibling);
              }
            }
      ...
      if (!this.actionQueueTimeout) {
        return this.actionQueueTimeout = $setImmediate(__bind(function() {
          ...
          if (this.fragment && this.rendererMap.length === 0 && this.fragment.hasChildNodes()) {
            $insertBefore(this.parentNode, this.fragment, this.nextSibling());
            this.fragment = document.createDocumentFragment();
          }
    ...
    IteratorBinding.prototype.nextSibling = function() {
      ...
      } else if ((_ref = this.initialSiblingNode) != null ? _ref.parentNode : void 0) {
