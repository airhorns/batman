(function() {
  ...
  Batman.Model = (function() {
    ...
    Model.prototype.save = function(callback) {
      ...
      return this.validate(__bind(function(isValid, errors) {
        var associations, belongsTo, creating, hasMany, hasOne, k, modelSaved, _k, _len3, _ref4;
        if (!isValid) {
          if (typeof callback === "function") {
            callback(errors);
          }
        ...
        if (associations = this.constructor.associations) {
          ...
          _ref4 = [belongsTo, hasOne, hasMany];
  ...
  Batman.Association = (function() {
    function Association(model, label, relatedModel) {
      var getAccessor, self, type, _base;
      this.model = model;
      this.label = label;
      this.relatedModel = relatedModel;
      type = $functionName(this.constructor);
      model.associations || (model.associations = {});
      (_base = model.associations)[type] || (_base[type] = new Batman.Hash);
      model.associations[type].set(this, label);
      this.addEncoder();
      self = this;
  ...
  Batman.Association.belongsTo = (function() {
    ...
    belongsTo.prototype.getAccessor = function(model, label, relatedModel) {
      ...
      if (relatedRecord = (_ref = this._batman.attributes) != null ? _ref[label] : void 0) {
        ...
        relatedRecord = new relatedModel({
          id: relatedID
        });
        relatedRecord.load(__bind(function(error, loadedRecord) {
          if (error) {
            throw error;
          }
          return relatedRecord = loadedRecord;
        }, this));
        return relatedRecord;
      }
    };
