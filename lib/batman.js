(function() {
  ...
  Batman.Association.belongsTo = (function() {
    function belongsTo(model, label, relatedModel) {
      var _base;
      this.model = model;
      this.label = label;
      this.relatedModel = relatedModel;
      model.associations || (model.associations = {});
      (_base = model.associations).belongsTo || (_base.belongsTo = new Batman.Set);
      model.associations.belongsTo.add(this);
  ...
  Batman.Association.hasOne = (function() {
    function hasOne(model, label, relatedModel) {
      var _base;
      this.model = model;
      this.label = label;
      this.relatedModel = relatedModel;
      model.associations || (model.associations = {});
      (_base = model.associations).hasOne || (_base.hasOne = new Batman.Set);
      model.associations.hasOne.add(this);
      model.accessor(label, {
        get: function() {
  ...
  Batman.Association.hasMany = (function() {
    function hasMany(model, label, relatedModel) {
      var _base;
      this.model = model;
      this.label = label;
      this.relatedModel = relatedModel;
      model.associations || (model.associations = {});
      (_base = model.associations).hasMany || (_base.hasMany = new Batman.Set);
      model.associations.hasMany.add(this);
      model.accessor(label, {
        get: function() {
