(function() {
  ...
  Batman.ControllerActionRoute = (function() {
    ...
    ControllerActionRoute.prototype.testKeys = ['controller', 'action'];
  ...
  Batman.RouteMap = (function() {
    ...
    RouteMap.prototype.routeForParams = function(params) {
      var key, route, routeOrMap, _ref;
      _ref = this.children;
      for (key in _ref) {
        routeOrMap = _ref[key];
        if (routeOrMap.isRoute) {
          if (routeOrMap.test(params)) {
            return routeOrMap;
          }
        } else {
          if (route = routeOrMap.routeForParams(params)) {
            return route;
          }
        }
      }
    ...
    RouteMap.prototype.addRoute = function(name, route) {
      developer["do"](__bind(function() {
        if (this.children[name]) {
          return Batman.developer.error("Route with name " + name + " already exists!");
        }
      }, this));
      return this.children[name] = route;
    };
    return RouteMap;
  })();
  Batman.RouteMapBuilder = (function() {
    ...
    RouteMapBuilder.ROUTES = {
      ...
      show: {
        ...
        name: function(resource) {
          return helpers.singularize(resource);
        }
      },
      edit: {
        cardinality: 'member',
        ...
        name: function(resource) {
          return "" + (helpers.singularize(resource)) + ".edit";
        }
      },
      collection: {
        cardinality: 'collection',
      ...
      member: {
        ...
        name: function(resource, name) {
          return "" + (helpers.singularize(resource)) + "." + name;
        }
      }
    };
