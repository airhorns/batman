  ...
  Batman.SetSort = (function() {
    ...
    SetSort.prototype._reIndex = function() {
      ...
      newOrder = this.base.toArray().sort(__bind(function(a, b) {
        var valueA, valueB, _ref2, _ref3;
        valueA = (_ref2 = (Batman.Observable.property.call(a, this.sortKey)).getValue()) != null ? _ref2.valueOf() : void 0;
        valueB = (_ref3 = (Batman.Observable.property.call(b, this.sortKey)).getValue()) != null ? _ref3.valueOf() : void 0;
        if (valueA < valueB) {
          return -1;
