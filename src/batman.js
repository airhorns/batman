(function() {
  var $block, $event, $eventOneShot, $findName, $mixin, $redirect, $route, $typeOf, $unmixin, Batman, Validators, camelize_rx, capitalize_rx, container, escapeRegExp, filters, helpers, matchContext, mixins, namedOrSplat, namedParam, queryParam, splatParam, underscore_rx1, underscore_rx2, _Batman, _objectToString, _stateMachine_setState;
  ...
  */
  ...
  Batman.Hash = (function() {
    var Hash, k, _i, _len, _ref;
    Hash = Batman.SimpleHash;
  ...
  Batman.Set = (function() {
    var Set, k, _i, _j, _len, _len2, _ref, _ref2;
    Set = Batman.SimpleSet;
  ...
  Batman.DOM = {
    ...
    attrReaders: {
      ...
      foreach: function(node, iteratorName, key, contexts, parentRenderer) {
        var add, collection, context, contextsClone, nodeMap, parent, prototype, remove, sibling;
